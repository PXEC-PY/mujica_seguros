    ...
    <div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          <Reveal delay={0.05}>
            <Link
              to={path('business')}
              className="group flex h-full flex-col items-start gap-4 rounded-lg bg-navy p-8 text-white shadow-sm transition-shadow hover:shadow-lg sm:p-10"
            >
          ...
          <Reveal delay={0.12}>
            <Link
              to={path('individuals')}
              className="group flex h-full flex-col items-start gap-4 rounded-lg border border-gray-200 p-8 shadow-sm transition-shadow hover:shadow-lg sm:p-10"
            >
      ...
      <section className="bg-navy-dark py-12 text-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 sm:grid-cols-2 lg:grid-cols-4">
          {home.features.map((f, index) => (
            <Reveal key={f.title} delay={Math.min(index * 0.08, 0.24)} className="text-center">
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-10 px-6 py-16 lg:grid-cols-2">
        <Reveal delay={0.1} className="overflow-hidden rounded-lg shadow-xl lg:order-2">
