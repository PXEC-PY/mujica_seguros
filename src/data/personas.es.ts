...
const personas: Coverage[] = [
  {
    ...
    icon: 'shield',
    shortDescription: 'Protección económica para tu familia.',
    intro:
      'Protege económicamente a tu familia ante un fallecimiento o invalidez, con un capital asegurado a elección.',
  ...
  },
  {
    ...
    icon: 'user',
    shortDescription: 'Cobertura ante accidentes de la vida diaria.',
    intro:
      'Cobertura ante accidentes que causen invalidez, fallecimiento o gastos médicos, dentro y fuera del horario laboral.',
  ...
  },
  {
    ...
    intro:
      'Cobertura de gastos médicos, internación y estudios ante enfermedad o accidente, con planes en Paraguay y el exterior.',
  ...
  },
  {
    ...
    title: 'Hogar',
    icon: 'building',
    shortDescription: 'Protección de tu vivienda y tus bienes.',
    intro:
      'Protección de tu vivienda y sus bienes ante incendio, robo, daños eléctricos y responsabilidad civil frente a terceros.',
  ...
  },
  {
    ...
    title: 'Automóviles',
    icon: 'car',
    shortDescription: 'Cobertura para tu vehículo particular.',
    intro:
      'Cobertura de responsabilidad civil y daños para tu vehículo particular, con asistencia en caso de siniestro.',
