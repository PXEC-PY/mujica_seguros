...
// NOTA: o conteúdo estendido (about, benefits, risks, ctaBanner/feature, faq) ainda
// está em espanhol como preenchimento temporário, aguardando a tradução real ao português.
